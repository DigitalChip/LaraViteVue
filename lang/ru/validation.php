...
return [
    ...
    */
	...
	// кастомные поля и правила при валидации
	'custom'               => [
		'attribute-name' => [
			'rule-name' => 'custom-message',
		],
		'role' => [
			'required' => ':attribute должна быть определена.',
		],
		'description' =>[
			'between' => 'В поле :attribute должно быть от :min до :max символов.',
		],
	],
	'attributes'           => [
		'address'               => 'Адрес',
